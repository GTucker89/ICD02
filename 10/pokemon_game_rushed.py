...
# Additional Moves (without specific moves)
dragon_claw = ["Dragon Claw", 80, "Dragon", "Physical", 100, None]
dark_pulse = ["Dark Pulse", 80, "Dark", "Special", 100, None]
thunderbolt = ["Thunderbolt", 90, "Electric", "Special", 100, None]
psycho_cut = ["Psycho Cut", 70, "Psychic", "Physical", 100, None]
psychic_move = ["Psychic", 90, "Psychic", "Special", 100, None]
ice_beam = ["Ice Beam", 90, "Ice", "Special", 100, None, (10, "freeze")]
blizzard = ["Blizzard", 110, "Ice", "Special", 70, None, (10, "freeze")]
focus_blast = ["Focus Blast", 120, "Fighting", "Special", 70, None]
stone_edge = ["Stone Edge", 100, "Rock", "Physical", 80, None]
earthquake = ["Earthquake", 100, "Ground", "Physical", 100, None]
giga_drain = ["Giga Drain", 75, "Grass", "Special", 100, None, (50, "heal")]
vine_whip = ["Vine Whip", 45, "Grass", "Physical", 100, None]
hydro_pump = ["Hydro Pump", 110, "Water", "Special", 80, None]
# Additional Moves (with specific moves)
gust = ["Gust", 40, "Flying", "Special", 100, None]
bubble = ["Bubble", 40, "Water", "Special", 100, None]
karate_chop = ["Karate Chop", 50, "Fighting", "Physical", 100, None]
low_sweep = ["Low Sweep", 65, "Fighting", "Physical", 100, None]
brick_break = ["Brick Break", 75, "Fighting", "Physical", 100, None]
dazzling_gleam = ["Dazzling Gleam", 80, "Fairy", "Special", 100, None]
cross_chop = ["Cross Chop", 100, "Fighting", "Physical", 80, None]
bubble_beam = ["Bubble Beam", 65, "Water", "Special", 100, None]
rock_slide = ["Rock Slide", 75, "Rock", "Physical", 90, None]
confusion = ["Confusion", 50, "Psychic", "Special", 100, None]
poison_sting = ["Poison Sting", 15, "Poison", "Physical", 100, None]
psybeam = ["Psybeam", 65, "Psychic", "Special", 100, None]
...
charmander = ["Fire", "None", 39, 52, 43, 60, 50, 65, 16, "Blaze", "None", "Solar Power", "Charmander", scratch, flamethrower, dragon_claw, fire_blast, ember]
squirtle = ["Water", "None", 44, 48, 65, 50, 64, 43, 16, "Torrent", "None", "Rain Dish", "Squirtle", tackle, water_gun, headbutt, hydro_pump]
bulbasaur = ["Grass", "Poison", 45, 49, 49, 65, 65, 45, 16, "Overgrow", "None", "Chlorophyll", "Bulbasaur", tackle, magical_leaf, vine_whip]
eevee = ["Normal", "None", 55, 55, 50, 45, 65, 55, None, "Run Away", "Adaptability", "Anticipation", "Eevee", tackle, quick_attack, covet, headbutt]
machop = ["Fighting", "None", 70, 80, 50, 35, 35, 35, 28, "Guts", "No Guard", "Steadfast", "Machop", brick_break, karate_chop, rock_tomb, rock_smash, low_sweep]
abra = ["Psychic", "None", 25, 20, 15, 105, 55, 90, 16, "Synchronize", "Inner Focus", "Magic Guard", "Abra", confusion, psybeam, psychic_move]
sandshrew = ["Ground", "None", 50, 75, 85, 20, 30, 40, 22, "Sand Veil", "Sand Rush", "Snow Cloak", "Sandshrew", scratch, mud_slap, rock_slide, earthquake]
tentacool = ["Water", "Poison", 40, 40, 35, 50, 100, 70, 30, "Clear Body", "Liquid Ooze", "Rain Dish", "Tentacool", poison_sting, water_gun, bubble_beam, hydro_pump]
jigglypuff = ["Normal", "Fairy", 115, 45, 20, 45, 25, 20, 16, "Cute Charm", "Competitive", "Friend Guard", "Jigglypuff", pound, dazzling_gleam, hyper_voice,psychic_move]

#Gives the list of pokemon that can be encountered on the first route
first_route_pokemon = [wattrel,zigzagoon,geodude,charmander,squirtle,bulbasaur,eevee,machop,abra,sandshrew,tentacool,jigglypuff]
...
def swap_team(team_current,team):
    swap_x = True
...
def battle_wild(team,enemy):
    print(team[0][26],team[1][26],team[2][26],team[3][26],team[4][26],team[5][26])
    ...
    while x:
        while y:
            ...
            if choice == "battle":
                ...
                rn = team_current
                team_current = swap_team(team_current,team)
                if rn != team_current:
                    turnused = True
                else:
                    turnused = False
                ...
                if captured == True:
                    while x:
                                ...
                                print(team[4][26])
                                print(team[5][26])
                                player_swap = int(input("Enter the number of the Pokemon you would like to swap to (0 to cancel): "))                                
                                if 0 < player_swap <= len(team):
                                    team[player_swap - 1] = enemy  # Update the selected Pokemon in the team
                                    x = False
                                    y = False
                                    turnused = False
                                    print(f"{enemy[26]} was added to your party!")
                                elif player_swap == 0:
                                    x = False
                                    y = False
                                    turnused = False
